...
<div id="modal-popup-box" class="modal">
    ...
    <form id="modal-popup-form" action="{{ route("admin.colecoes.deletemany") }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div id="ids">
        </div>
        <h1 id="modal-title">Deletar todas as coleções selecionados <br> permanentemente?</h1>
        {{-- @if ($errors->any())
            <div class="error-msg">
                <ul>
