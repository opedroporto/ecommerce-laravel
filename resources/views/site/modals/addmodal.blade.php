...
{{-- <label for="addmodal" class="btn btn-add">
    <p>
        <button class="address-add" type="button" onclick="appendaddress(this)">
...
<div id="modal-popup-box" class="modal">
    ...
    <form id="modal-popup-form" class="form" action="{{ route("site.addendereco") }}" method="POST" enctype="multipart/form-data">
        @csrf
